...
class Scraper
{
     ...
     * @param null|int     $max_trackers Optional. Maximum number of trackers to be scraped, Default all.
     ...
     *
     * @throws Exception|RangeException in case of invalid amount of info-hashes
     *
    ...
    private function scrape_http($infohashes, $protocol, $host, $port, $passkey, $announce)
    {
        ...
        return $this->http_data($response, $infohashes, $host);
    }
    ...
    private function http_query($infohashes, $protocol, $host, $port, $passkey)
    {
        ...
        return $tracker_url . $scrape_query;
    }
    ...
    private function prepare_udp($host, $port)
    {
        ...
        return [$socket, $transaction_id, $connection_id];
    }
