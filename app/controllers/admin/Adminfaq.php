...
class Adminfaq extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($faq_categ)) {
            ...
            $this->view('faq/admin/manage', $data, 'admin');
        }
    }
    ...
    public function delete()
    {
        if ($_GET['confirm'] == "yes") {
            ...
            Session::flash('info', "Please click <a href=\"" . URLROOT . "/adminfaq/delete?id=$_GET[id]&amp;confirm=yes\">here</a> to confirm.", URLROOT . "/adminfaq");
        }
    }
    ...
    public function newsection()
    {
        ...
        $this->view('faq/admin/newsection', $data, 'admin');
    }
    ...
    public function additem()
    {
        ...
        $this->view('faq/admin/newitem', $data, 'admin');
    }
    ...
    public function edit()
    {
        ...
        $this->view('faq/admin/edit', $data, 'admin');
    }
