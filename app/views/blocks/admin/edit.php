...
<form name="blocks" method="post" action="<?php echo URLROOT ?>/adminblocks/edit">
    ...
    while ($blocks2 = $data['res']->fetch(PDO::FETCH_ASSOC)) {
        ...
        print("<tr>" . # id=\"qq"\" - removed
            ...
            "</tr>" .
            "<tr>" .
            "<td class=\"$class\" height=\"1%\">" . ((($blocks2["position"] != "left") && ($blocks2["enabled"] == 1)) ? "<a href=\"" . URLROOT . "/adminblocks/edit?edit=true&amp;position=left&amp;left=" . $blocks2["id"] . "\"><img border=\"0\" src=\"" . URLROOT . "/assets/images/blocks/leftenable.gif\" width=\"18\" height=\"15\"  /></a>" : "<img border=\"0\" src=\"" . URLROOT . "/assets/images/blocks/leftdisable.gif\" width=\"18\" height=\"15\" " . ($blocks2["enabled"] ? "alt=\"" . Lang::T("_AT_LEFT_") . "\"" : "") . " " . ($blocks2["enabled"] ? "onclick=\"javascript: alert('" . Lang::T("_AT_LEFT_") . "');\"" : "onclick=\"javascript: alert('" . Lang::T("_MUST_ENB_FIRST") . "');\"") . "  />") . "</td>" .
            "<td class=\"$class\" height=\"1%\">" . ((($blocks2["position"] != "middle") && ($blocks2["enabled"] == 1)) ? "<a href=\"" . URLROOT . "/adminblocks/edit?edit=true&amp;position=middle&amp;middle=" . $blocks2["id"] . "\"><img border=\"0\" src=\"" . URLROOT . "/assets/images/blocks/middleenable.gif\" width=\"18\" height=\"15\" /></a>" : "<img border=\"0\" src=\"" . URLROOT . "/assets/images/blocks/middledisable.gif\" width=\"18\" height=\"15\" " . ($blocks2["enabled"] ? "alt=\"" . Lang::T("_AT_CENTER_") . "\"" : "") . " " . ($blocks2["enabled"] ? "onclick=\"javascript: alert('" . Lang::T("_AT_CENTER_") . "');\"" : "onclick=\"javascript: alert('" . Lang::T("_MUST_ENB_FIRST") . "');\"") . "  />") . "</td>" .
            "<td class=\"$class\" height=\"1%\">" . ((($blocks2["position"] != "right") && ($blocks2["enabled"] == 1)) ? "<a href=\"" . URLROOT . "/adminblocks/edit?edit=true&amp;position=right&amp;right=" . $blocks2["id"] . "\"><img border=\"0\" src=\"" . URLROOT . "/assets/images/blocks/rightenable.gif\" width=\"18\" height=\"15\" /></a>" : "<img border=\"0\" src=\"" . URLROOT . "/assets/images/blocks/rightdisable.gif\" width=\"18\" height=\"15\" " . ($blocks2["enabled"] ? "alt=\"" . Lang::T("_AT_RIGHT_") . "\"" : "") . " " . ($blocks2["enabled"] ? "onclick=\"javascript: alert('" . Lang::T("_AT_RIGHT_") . "');\"" : "onclick=\"javascript: alert('" . Lang::T("_MUST_ENB_FIRST") . "');\"") . "  />") . "</td>" .
            "<td class=\"$class\" height=\"1%\">" . ((($blocks2["sort"] != 1) && ($blocks2["enabled"] != 0)) ? "<a href=\"" . URLROOT . "/adminblocks/edit?edit=true&amp;position=" . $blocks2["position"] . "&amp;sort=" . $blocks2["sort"] . "&amp;up=" . $blocks2["id"] . "\"><img border=\"0\" src=\"" . URLROOT . "/assets/images/blocks/updisable.gif\" width=\"18\" height=\"15\" /></a>" : "<img border='0' src=\"" . URLROOT . "/assets/images/blocks/updisable.gif\" width=\"18\" height=\"15\" alt=\"" . ($blocks2["enabled"] ? "" . Lang::T("_AT_TOP_") . "" : "") . "\" " . ($blocks2["enabled"] ? "onclick=\"javascript: alert('" . Lang::T("_AT_TOP_") . "');\"" : "onclick=\"javascript: alert('" . Lang::T("_MUST_ENB_FIRST") . "');\"") . " />") . "</td>" .
            "<td class=\"$class\" height=\"1%\">" . (((($blocks2["sort"] != ($nextleft - 1)) && ($blocks2["position"] == "left") || ($blocks2["sort"] != ($nextright - 1)) && ($blocks2["position"] == "right") || ($blocks2["sort"] != ($nextmiddle - 1)) && ($blocks2["position"] == "middle")) && ($blocks2["enabled"] != 0)) ? "<a href=\"" . URLROOT . "/adminblocks/edit?edit=true&amp;position=" . $blocks2["position"] . "&amp;sort=" . $blocks2["sort"] . "&amp;down=" . $blocks2["id"] . "\"><img border=\"0\" src=\"" . URLROOT . "/assets/images/blocks/downenable.gif\" width=\"18\" height=\"15\" /></a>" : "<img border=\"0\" src=\"" . URLROOT . "/assets/images/blocks/downdisable.gif\" width=\"18\" height=\"15\" alt=\"" . ($blocks2["enabled"] ? "" . Lang::T("_AT_BOTTOM_") . "" : "") . "\" " . ($blocks2["enabled"] ? "onclick=\"javascript: alert('" . Lang::T("_AT_BOTTOM_") . "');\"" : "onclick=\"javascript: alert('" . Lang::T("_MUST_ENB_FIRST") . "');\"") . " />") . "</td>" .
            "</tr>");
    }
    print("<tr>" .
