...
if ($res->rowCount()) {?>
	...
	<?php while ($array = $res->fetch(PDO::FETCH_ASSOC)) {?>
			<dt><a href='<?php echo URLROOT; ?>/comments?type=news&amp;id=<?php echo $array['id']; ?>'><strong><?php echo $array['title']; ?></strong></a></dt><dd><strong><?php echo Lang::T("POSTED"); ?>:</strong> <?php echo gmdate("d-M-y", TimeDate::utc_to_tz_time($array["added"])); ?><dd>
		<?php }?>
	</dl>
