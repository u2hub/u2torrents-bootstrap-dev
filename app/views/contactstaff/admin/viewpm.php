...
<?php
print(($data["sender1"] ? "<a href=" . URLROOT . "/admincontactstaff/answermessage?receiver=" . $data["sender1"] . "&answeringto=$data[iidee]><b>Reply</b></a>" : "<font class=gray><b>Reply</b></font>") . " | <a href=" . URLROOT . "/admincontactstaff/deletestaffmessage?id=" . $data["id"] . "><b>Delete</b></a></td>");
?>
</td></tr></table>