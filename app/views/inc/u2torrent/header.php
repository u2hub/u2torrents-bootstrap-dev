...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap & core CSS -->
    <link href="<?php echo URLROOT; ?>/assets/themes/u2torrent/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="<?php echo URLROOT; ?>/assets/themes/u2torrent/customstyle.css" rel="stylesheet">
    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.15.6/styles/github.min.css">
  </head>
<body>
  <?php require APPROOT . '/views/inc/u2torrent/navbar.php'; ?>
<!-- START MAIN COLUMN -->
