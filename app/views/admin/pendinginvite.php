<?php Style::begin("Invited Pending Users"); ?>
 <center>
    ...
    <?php if ($data['count'] > 0): ?>
    <br />
    <form id="pendinginvite" method="post" action="<?php echo URLROOT; ?>/adminpendinginvite">
    ...
    <tr>
        ...
        <td class="table_col2" align="center"><a href="<?php echo URLROOT; ?>/users/profile?id=<?php echo $row["invited_by"]; ?>"><?php echo $row["inviter"]; ?></a></td>
