...
Style::begin(Lang::T("THEME_MANAGEMENT"));
            echo "<center><a href=" . URLROOT . "adminstylesheet?do=add'>" . Lang::T("THEME_ADD") . "</a><!-- - <b>" . Lang::T("THEME_CLICK_A_THEME_TO_EDIT") . "</b>--></center>";
            echo "<center>" . Lang::T("THEME_CURRENT") . ":<form id='deltheme' method='post' action=" . URLROOT . "adminstylesheet?do=del'></center><table class='table table-striped table-bordered table-hover'>
        <thead>" .
            ...
            echo "<p>" . Lang::T("THEME_IN_THEMES_BUT_NOT_IN_DB") . "</p><form id='addtheme' action='adminstylesheet?do=add2' method='post'><table class='table table-striped table-bordered table-hover'><thead>" .
