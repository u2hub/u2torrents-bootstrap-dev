...
if ($allcat == 0) {
    ...
    foreach ($forumcat as $row) {
        ...
        echo "<td class='table_col1' width='18'><a href='".URLROOT."/adminforum/delcat?id=$row[id]'><img src='".URLROOT."/assets/images/delete.png' alt='" . Lang::T("FORUM_DELETE_CATEGORY") . "' width='17' height='17' border='0' /></a></td></tr>\n";
    }
} ?>
</tbody></table>
</div>
...
<tr>
<th class='table_head' colspan='2' align='center'>
<input type='submit' value='<?php echo Lang::T("FORUM_ADD_NEW_CAT") ?>' />
<input type='reset' value='<?php echo Lang::T("RESET") ?>' />
</th>
</tr>
</table></div>
