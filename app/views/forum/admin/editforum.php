...
<input type="hidden" name="id" value="<?php echo $data['id']; ?>" />
    ...
    <td class='table_col2' align='right'><input type="text" name="changed_forum" class="option" size="35" value="<?php echo $data["name"]; ?>" /></td>
    </tr><tr class='f-form'>
    <td class='table_col1'>Sort Order:</td>
    <td class='table_col2' align='right'><input type="text" name="changed_sort" class="option" size="35" value="<?php echo $data["sort"]; ?>" /></td>
    </tr><tr class='f-form'>
    <td class='table_col1'>Description:</td>
    <td class='table_col2' align='right'><textarea cols='50' rows='5' name='changed_forum_desc'><?php echo $data["description"]; ?></textarea></td>
    </tr><tr class='f-form'>
...
<option value='<?echo _ADMINISTRATOR; ?>'>Administrator</option>
    ...
    <td align='right'><input type="radio" name="guest_read" value="yes" <?php echo $data["guest_read"] == "yes" ? "checked='checked'" : "" ?> />Yes,
	<input type="radio" name="guest_read" value="no" <?php echo $data["guest_read"] != "yes" ? "checked='checked'" : "" ?> />No</td></tr>
    <tr>
